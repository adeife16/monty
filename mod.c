...
/**
 * process_modulo - Calculates the modulo of the top two elements of the stack
 * @head: Double pointer to the head of the stack
 * @line_number: Line number being processed
 *
 * Description: Computes the modulo of the second element by the top element
 ...
 */
void process_modulo(data_t **head, unsigned int line_number) {
